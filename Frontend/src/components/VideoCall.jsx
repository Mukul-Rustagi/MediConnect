...
function VideoCall() {
  ...
  // Destructure the state you passed from navigate
  const { role, doctorData, patientData } = location.state || {};
      ...
      try {
        if (role === "Patient") {
          ...
          const res = await axios.post(
            `${import.meta.env.VITE_API_URL}/api/sendSocketCode`,
            {
    ...
    <div className="app">
      <div className="container">
        ...
        <div className="input-container">
          ...
          <button onClick={endCall} disabled={callStatus === "disconnected"}>
            End
          </button>
        </div>
